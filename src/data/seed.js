export const seedProducts = [
  ...
  {
    id: 'P1005',
    name: 'Football Training Cones Pack',
    category: 'Football',
    price: 4200,
    stock: 35,
    status: 'Available',
  ...
  {
    id: 'P1017',
    name: 'Volleyball Training Shoes',
    category: 'Volleyball',
    price: 23500,
    stock: 9,
    status: 'Available',
...
export const seedRequests = [
  {
    ...
    quantity: 1,
    status: 'Accepted',
    message: 'I need this football for school team practice.',
    adminResponse: 'Your product is available. You can visit our store.',
  ...
  },
  {
    ...
    quantity: 2,
    status: 'Pending',
    message: 'Please reserve two badminton rackets for weekend training.',
    adminResponse: '',
  ...
  },
  {
    ...
    quantity: 1,
    status: 'Rejected',
    message: 'I want to buy this resistance band set this week.',
    adminResponse: 'Sorry, your product request is currently not available.',
    createdAt: '2026-06-14',
  },
];

export function initializeSeedData() {
  if (!localStorage.getItem('sportzone_products')) {
    localStorage.setItem('sportzone_products', JSON.stringify(seedProducts));
  }

  if (!localStorage.getItem('sportzone_users')) {
    localStorage.setItem('sportzone_users', JSON.stringify(seedUsers));
  }

  if (!localStorage.getItem('sportzone_requests')) {
